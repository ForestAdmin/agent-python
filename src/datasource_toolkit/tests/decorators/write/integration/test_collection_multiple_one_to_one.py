...
class TestMultipleOneToOne(TestCase):
    @classmethod
    ...
    def test_create_relations_and_attach_to_new_collection(self):
        ...
        book_create_patcher = patch.object(
            ...
            return_value=[{"id": "123e4567-e89b-12d3-a456-111111111111", "notImportantColumn": "foo", "title": "name"}],
        )
        ...
        # then
        book_create_mock.assert_awaited_once_with(self.mocked_caller, [{"title": "name"}])
        person_create_mock.assert_awaited_once_with(
            self.mocked_caller, [{"book_id": "123e4567-e89b-12d3-a456-111111111111", "name": "Orius"}]
        )
        format_create_mock.assert_awaited_once_with(
            self.mocked_caller, [{"book_id": "123e4567-e89b-12d3-a456-111111111111", "name": "XXL"}]
        )
