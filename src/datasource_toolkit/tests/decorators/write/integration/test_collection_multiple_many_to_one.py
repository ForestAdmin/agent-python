...
class TestMultipleManyToOne(TestCase):
    @classmethod
    ...
    def test_create_relations_and_attach_to_new_collection(self):
        ...
        book_create_mock.assert_awaited_once_with(
            ...
            [
                {
                    "format_id": "123e4567-e89b-12d3-a456-222222222222",
                    "author_id": "123e4567-e89b-12d3-a456-111111111111",
                    "title": "name",
                }
            ],
        )
        person_create_mock.assert_awaited_once_with(self.mocked_caller, [{"name": "Orius"}])
