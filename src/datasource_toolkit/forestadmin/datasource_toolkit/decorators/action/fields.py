...
from forestadmin.datasource_toolkit.interfaces.actions import ActionField, ActionFieldType, ActionLayoutItem, File
...
class LayoutDynamicElement(FormElement):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.widget == "Page":
            self._widget_fields["elements"] = [FormElementFactory.build(e) for e in self._widget_fields["elements"]]
        elif self.widget == "Row":
            self._widget_fields["fields"] = [FormElementFactory.build(field) for field in self._widget_fields["fields"]]
...
DynamicFormElement = Union[DynamicField, LayoutDynamicElement]
...
class FormElementFactory:
    ...
    @classmethod
    def build(cls, plain_field: PlainDynamicFormElement) -> DynamicField:
        try:
